...
protected:
    ...
    void init(const char*file,const char*message,int line);
public:
    ...
    virtual ~Exception() = 0 ;//纯虚析构函数也可以定义函数体
};
